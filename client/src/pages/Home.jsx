...
const Home = () => {
  ...
  useEffect(()=>{{/*Fetch posts function*/}
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Browse through a selection of previously generated images all created by DALL-E AI</p>
      </div>
      <div className='mt-16'>
        <FormField
