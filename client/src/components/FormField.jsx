...
const FormField = ({labelName,type,name,placeholder,value,handleChange, isSurpriseMe, handleSurpriseMe}) => {
  return (
    <div>
      ...
      className='bg-gray-50 border border-grey-300 text-grey-900 text-sm rounded-lg hover:border-purple-300 hover:ring-purple-300 focus:ring-[#4649ff] focus:border-[#4649ff] outline-none block w-full p-3' />
    </div>
  )
}
